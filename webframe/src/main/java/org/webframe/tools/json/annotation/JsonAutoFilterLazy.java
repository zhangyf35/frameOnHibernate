 ...
 * {@code @RequestMapping("/list")}<br>
 * {@code @ResponseBody}<br>
 * {@code @JsonAutoFilterLazy}<br>
 * public User list() {<br>
 ...
 *     		{@code @Filter}(clazz=User.class,fields={"password","email"})<br>
 *     }<br>
 * )<br>
 * 
 ...
 *     extraFilterFields={<br>
 *     		{@code @Filter}(clazz=User.class,fields={"password","email"}),<br>
 *     		{@code @Filter}(clazz=Commodity.class,fields={"price"})<br>
 *     }<br>
 * )<br>
 * 
